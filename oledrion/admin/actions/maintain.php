...
switch ($action) {
    ...
    case 'doimport':
		...
		if($categories == 0) {
	        ...
	        $product_array = array(
	        	'product_id' => 1, 'product_cid' => 1, 'product_title' => 'Test product', 'product_vendor_id' => 1,
			    'product_submitter' => 1, 'product_online' => 1, 'product_submitted' => time(), 'product_price' => '100',
